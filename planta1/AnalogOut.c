...
static void mdlUpdate(SimStruct *S, int_T tid)
{
    ...
    UNUSED_ARG(tid); /* not used in single tasking mode */
        ...
        plant_dyna1_type plant_dyna1_ptr = NULL;
        plant_dyna1_ptr = (plant_dyna1_type)GetProcAddress(dllHandle,"plant_dynamics1");
        plant_dyna2_type plant_dyna2_ptr = NULL;
        plant_dyna2_ptr = (plant_dyna2_type)GetProcAddress(dllHandle,"plant_dynamics2");
        plant_dyna3_type plant_dyna3_ptr = NULL;
        plant_dyna3_ptr = (plant_dyna3_type)GetProcAddress(dllHandle,"plant_dynamics3");
    #endif
